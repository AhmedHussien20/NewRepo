//var baseUrl = 'https://portal.fra.org.zm:8020/';
...
$(document).ready(function () {
    try {
        ...
        document.getElementById('filePath').onchange = function (evt) {
...
function formatCurrency(amount, currencyCode = 'ZMW') {
    ...
    for (const part of parts) {
        if (part.type !== 'currency') {
            formattedNumber += part.value.replace(',', '') + ' ';
        }
    }
    return formattedNumber.trim();
}
function noBreak(inputString) {
